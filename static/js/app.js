...
/* The mycomputer angular application */
var mycomputer = angular.module('mycomputer', [
  'ngRoute',
  'mycomputerControllers'
]);

/* Configurate application like router and others*/
mycomputer.config(['$locationProvider', '$routeProvider',
...
/* Gravatar directive */
mycomputer.directive('gravatarImage', function () {
  return {
    restrict: 'AE',
    replace: true,
    required: 'email',
